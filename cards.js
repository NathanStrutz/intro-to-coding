...
/**
 * Players hold their hand and decide how they play their game. They also count their wins.
 */
class Player {
  constructor() {
    this.numberOfWins = 0;
...
class Game {
  ...
  play(iterations = 1) {
    ...
    let ties = new Player(); // just to keep track of ties
    ...
    console.log("Tied:", ties.getWins(), "times");
  }
}

// Here's how to play the game from the command line - uncomment these 2 lines:
// let game = new Game();
// game.play(100);
