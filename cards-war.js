...
let gameRound = function (player1, player2) {
  ...
  if (card1.rank > card2.rank) {
    ...
    let p1BurnCards = [getTopCard(player1.hand), getTopCard(player1.hand), getTopCard(player1.hand)];
    let p2BurnCards = [getTopCard(player2.hand), getTopCard(player2.hand), getTopCard(player2.hand)];
    return winRound(warWinner, [card1, card2, ...p1BurnCards, ...p2BurnCards]);
  }
};
