...
class Army {
  ...
  dropBomb() {
    ...
    let alien = random(this.aliens);
    let bombX = this.x + alien.x + 25;
    let bombY = this.y + alien.y + 50;
...
class BunkerHill {
  constructor() {
    ...
    this.bunkers.push(new Bunker(375, shieldYLevel));
