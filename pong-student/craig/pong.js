...
let speedUpBy = 0.80; // speed multiplied every ball bounce
...
function speedUp() {
  // speed up ball
  if (ballSpeedX > 0 && ballSpeedX < 50) {
    ballSpeedX += speedUpBy;
  } else if (ballSpeedX < 0 && ballSpeedX > -50) {
    ballSpeedX -= speedUpBy;
  }
  if (ballSpeedY > 0 && ballSpeedY < 50) {
    ballSpeedY += speedUpBy;
  } else if (ballSpeedY < 0 && ballSpeedY > -50) {
    ballSpeedY -= speedUpBy;
  }
}
